...
namespace FanControl.CommanderCoreXt
{
    ...
    {
        public const String ERROR_LOG_FILE_NAME = "CommanderCORE-XT.err.log";

#if DEBUG
        public const String TRACE_LOG_FILE_NAME = "CommanderCORE-XT.trc.log";
#else
        public const String TRACE_LOG_FILE_NAME = "";
#endif

        public const Int32 VENDOR_ID = 0x1b1c;
        public const Int32 PRODUCT_ID = 0x0c2a;
